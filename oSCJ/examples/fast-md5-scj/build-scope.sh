...
FIJI_HOME="../../../../"
SCJFLAGS="--scj --scj-scope-backing 500k --g-def-immortal-mem 500k --g-scope-checks yes --pollcheck-mode none"   #700 scope, 500 imm
...
# COMPILE FIJI
$FIJI_HOME/bin/fivmc -o md5-scope --scj-safelet md5scj.MD5SCJ $FIJIFLAGS $SCJFLAGS md5.jar
