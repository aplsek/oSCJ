...
cd build/ && find . -name "*.class" | xargs jar cf ../eqSolve.jar && cd ..
rm -rf list

# 

# COMPILE FIJI
$FIJI_HOME/bin/fivmc -o eqSolve --scj-safelet EqSolve $FIJIFLAGS $SCJFLAGS eqSolve.jar
	
	
# RUN:	
sudo ./eqSolve | tee eqSolve-scj.cap
