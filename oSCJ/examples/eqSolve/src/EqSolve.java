...
public class EqSolve extends CyclicExecutive {
    ...
    public class Handler extends PeriodicEventHandler {
        ...
        public boolean C_, C_delta, C_delta_1634, C_x_st_1, C_x_st_1_1639,
                C_c1, C_c1_1648, C_x_st_2, C_x_st_2_1653, C_x1_1, C_x1_1_1664,
                C__1669, C__1675, C_x1_2, C__1694, C_x_st, C_x21, C_x1;
        ...
        boolean eqSolve_step() throws Exception {
            ...
            System.out.println(" C_x1_2 : " + C_x1_2 + "\n");
            ...
            if (C_x21) {
                if (C_x1_1_1664)
                    ...
                    x21 = -((XZX_1585 + R_n) / (2.0f * XZX_1581));
            }
            if (C_x1) {
                if (C_c1_1648)
                    x1 = -(c / b);
        ...
        boolean eqSolve_step_finalize() throws Exception {
            Terminal.getTerminal().write(" \t FINALIZE :" + count_ + "\n");
