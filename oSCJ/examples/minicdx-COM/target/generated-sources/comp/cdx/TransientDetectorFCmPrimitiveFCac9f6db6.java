...
public class TransientDetectorFCmPrimitiveFCac9f6db6
implements org.objectweb.fractal.juliac.runtime.Factory {

  private Object content;
  public org.objectweb.fractal.api.Type getFcInstanceType()  {
    try {
      return new org.objectweb.fractal.julia.type.BasicComponentType( new org.objectweb.fractal.api.type.InterfaceType[]{new org.objectweb.fractal.julia.type.BasicInterfaceType("iTdToIe","comp.cdx.ITransDetectToImmEntry",true,false,false),new org.objectweb.fractal.julia.type.BasicInterfaceType("iStateTable","cdx.IStateTable",true,false,false),new org.objectweb.fractal.julia.type.BasicInterfaceType("iTransientDetector","cdx.ITransientDetector",false,false,false),new org.objectweb.fractal.julia.type.BasicInterfaceType("attribute-controller","comp.cdx.TDAttributes",false,false,false),} );
    }
  ...
  public Object getFcContentDesc()  {
      return "comp.cdx.TransientDetector";
  }
  ...
  public Object newFcContent()  {
    Object content = new comp.cdx.TransientDetector();
    return content;
  }
  ...
  public org.objectweb.fractal.api.Component newFcInstance(Object content) throws org.objectweb.fractal.api.factory.InstantiationException  {
    ...
    proxy = new comp.cdx.ITransDetectToImmEntryFcItf(mcomp,"iTdToIe",new org.objectweb.fractal.julia.type.BasicInterfaceType("iTdToIe","comp.cdx.ITransDetectToImmEntry",true,false,false),false,null);
    fcInterfaces.put("iTdToIe",proxy);
    proxy = new cdx.IStateTableFcItf(mcomp,"iStateTable",new org.objectweb.fractal.julia.type.BasicInterfaceType("iStateTable","cdx.IStateTable",true,false,false),false,null);
    fcInterfaces.put("iStateTable",proxy);
    proxy = new cdx.ITransientDetectorFcItf(mcomp,"iTransientDetector",new org.objectweb.fractal.julia.type.BasicInterfaceType("iTransientDetector","cdx.ITransientDetector",false,false,false),false,content);
    fcInterfaces.put("iTransientDetector",proxy);
    org.objectweb.fractal.julia.Interceptor intercept = new cdx.ITransientDetectorInterceptorLC();
    ...
    proxy = new comp.cdx.TDAttributesFcItf(mcomp,"attribute-controller",new org.objectweb.fractal.julia.type.BasicInterfaceType("attribute-controller","comp.cdx.TDAttributes",false,false,false),false,content);
