...
package rtsj.activity.lib;


public class NHRTPeriodicControllerImplFCmPrimitiveFC33debfea
implements org.objectweb.fractal.juliac.runtime.Factory {

  private Object content;
  public org.objectweb.fractal.api.Type getFcInstanceType()  {
    try {
      return new org.objectweb.fractal.julia.type.BasicComponentType( new org.objectweb.fractal.api.type.InterfaceType[]{new org.objectweb.fractal.julia.type.BasicInterfaceType("MemoryAreaSetter","rtsj.memory.api.SetMemoryAreaReferenceItf",false,false,false),new org.objectweb.fractal.julia.type.BasicInterfaceType("entryPoint","java.lang.Runnable",true,false,false),new org.objectweb.fractal.julia.type.BasicInterfaceType("PeriodicExecution","activity.api.PeriodicExecutionItf",false,false,false),new org.objectweb.fractal.julia.type.BasicInterfaceType("attribute-controller","activity.api.PeriodicControllerAttributes",false,false,false),} );
    }
  ...
  public Object getFcContentDesc()  {
      return "rtsj.activity.lib.NHRTPeriodicControllerImpl";
  }
  ...
  public Object newFcContent()  {
    Object content = new rtsj.activity.lib.NHRTPeriodicControllerImpl();
    return content;
  }
  ...
  public org.objectweb.fractal.api.Component newFcInstance(Object content) throws org.objectweb.fractal.api.factory.InstantiationException  {
    ...
    org.objectweb.fractal.julia.Interceptor intercept = new rtsj.memory.api.SetMemoryAreaReferenceItfInterceptorLC();
    ...
    proxy = new juliac.generated.java.lang.RunnableFcItf(mcomp,"entryPoint",new org.objectweb.fractal.julia.type.BasicInterfaceType("entryPoint","java.lang.Runnable",true,false,false),false,null);
    fcInterfaces.put("entryPoint",proxy);
    proxy = new activity.api.PeriodicExecutionItfFcItf(mcomp,"PeriodicExecution",new org.objectweb.fractal.julia.type.BasicInterfaceType("PeriodicExecution","activity.api.PeriodicExecutionItf",false,false,false),false,content);
    fcInterfaces.put("PeriodicExecution",proxy);
    intercept = new activity.api.PeriodicExecutionItfInterceptorLC();
    intercept.initFcController(ic);
    ((org.objectweb.fractal.julia.ComponentInterface)proxy).setFcItfImpl(intercept);
    intercept.setFcItfDelegate(content);
    proxy = new activity.api.PeriodicControllerAttributesFcItf(mcomp,"attribute-controller",new org.objectweb.fractal.julia.type.BasicInterfaceType("attribute-controller","activity.api.PeriodicControllerAttributes",false,false,false),false,content);
    fcInterfaces.put("attribute-controller",proxy);
