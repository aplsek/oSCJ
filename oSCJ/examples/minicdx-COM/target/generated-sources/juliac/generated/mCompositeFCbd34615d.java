...
public class mCompositeFCbd34615d
implements org.objectweb.fractal.juliac.runtime.Factory {

  private Object content;
  public org.objectweb.fractal.api.Type getFcInstanceType()  {
    try {
      return new org.objectweb.fractal.julia.type.BasicComponentType( new org.objectweb.fractal.api.type.InterfaceType[]{new org.objectweb.fractal.julia.type.BasicInterfaceType("IN","cdx.IStateTable",false,false,false),new org.objectweb.fractal.julia.type.BasicInterfaceType("OUT","cdx.IStateTable",true,false,false),new org.objectweb.fractal.julia.type.BasicInterfaceType("MemoryAreaSetter","rtsj.memory.api.SetMemoryAreaReferenceItf",false,false,false),} );
    }
  ...
  public org.objectweb.fractal.api.Component newFcInstance(Object content) throws org.objectweb.fractal.api.factory.InstantiationException  {
    ...
    proxy = new cdx.IStateTableFcItf(mcomp,"IN",new org.objectweb.fractal.julia.type.BasicInterfaceType("IN","cdx.IStateTable",false,false,false),false,null);
    fcInterfaces.put("IN",proxy);
    proxy = new cdx.IStateTableFcItf(mcomp,"IN",new org.objectweb.fractal.julia.type.BasicInterfaceType("IN","cdx.IStateTable",true,false,false),true,null);
    fcInternalInterfaces.put("IN",proxy);
    proxy = new cdx.IStateTableFcItf(mcomp,"OUT",new org.objectweb.fractal.julia.type.BasicInterfaceType("OUT","cdx.IStateTable",true,false,false),false,null);
    fcInterfaces.put("OUT",proxy);
    proxy = new cdx.IStateTableFcItf(mcomp,"OUT",new org.objectweb.fractal.julia.type.BasicInterfaceType("OUT","cdx.IStateTable",false,false,false),true,null);
