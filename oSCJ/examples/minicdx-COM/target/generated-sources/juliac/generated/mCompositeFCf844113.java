...
public class mCompositeFCf844113
implements org.objectweb.fractal.juliac.runtime.Factory {
  ...
  public org.objectweb.fractal.api.Component newFcInstance(Object content) throws org.objectweb.fractal.api.factory.InstantiationException  {
    ...
    proxy = new comp.cdx.ICollDetectToImmEntryFcItf(mcomp,"IN",new org.objectweb.fractal.julia.type.BasicInterfaceType("IN","comp.cdx.ICollDetectToImmEntry",false,false,false),false,null);
    fcInterfaces.put("IN",proxy);
    proxy = new comp.cdx.ICollDetectToImmEntryFcItf(mcomp,"IN",new org.objectweb.fractal.julia.type.BasicInterfaceType("IN","comp.cdx.ICollDetectToImmEntry",true,false,false),true,null);
    ...
    proxy = new comp.cdx.ICollDetectToImmEntryFcItf(mcomp,"OUT",new org.objectweb.fractal.julia.type.BasicInterfaceType("OUT","comp.cdx.ICollDetectToImmEntry",false,false,false),true,null);
