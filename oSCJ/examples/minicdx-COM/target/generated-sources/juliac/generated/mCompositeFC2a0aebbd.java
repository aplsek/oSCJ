...
public class mCompositeFC2a0aebbd
implements org.objectweb.fractal.juliac.runtime.Factory {

  private Object content;
  public org.objectweb.fractal.api.Type getFcInstanceType()  {
    try {
      return new org.objectweb.fractal.julia.type.BasicComponentType( new org.objectweb.fractal.api.type.InterfaceType[]{new org.objectweb.fractal.julia.type.BasicInterfaceType("IN","comp.cdx.ITransDetectToImmEntry",false,false,false),new org.objectweb.fractal.julia.type.BasicInterfaceType("OUT","comp.cdx.ITransDetectToImmEntry",true,false,false),new org.objectweb.fractal.julia.type.BasicInterfaceType("MemoryAreaSetter","rtsj.memory.api.SetMemoryAreaReferenceItf",false,false,false),} );
    }
  ...
  public org.objectweb.fractal.api.Component newFcInstance(Object content) throws org.objectweb.fractal.api.factory.InstantiationException  {
    ...
    proxy = new comp.cdx.ITransDetectToImmEntryFcItf(mcomp,"IN",new org.objectweb.fractal.julia.type.BasicInterfaceType("IN","comp.cdx.ITransDetectToImmEntry",false,false,false),false,null);
    fcInterfaces.put("IN",proxy);
    proxy = new comp.cdx.ITransDetectToImmEntryFcItf(mcomp,"IN",new org.objectweb.fractal.julia.type.BasicInterfaceType("IN","comp.cdx.ITransDetectToImmEntry",true,false,false),true,null);
    fcInternalInterfaces.put("IN",proxy);
    proxy = new comp.cdx.ITransDetectToImmEntryFcItf(mcomp,"OUT",new org.objectweb.fractal.julia.type.BasicInterfaceType("OUT","comp.cdx.ITransDetectToImmEntry",true,false,false),false,null);
    fcInterfaces.put("OUT",proxy);
    proxy = new comp.cdx.ITransDetectToImmEntryFcItf(mcomp,"OUT",new org.objectweb.fractal.julia.type.BasicInterfaceType("OUT","comp.cdx.ITransDetectToImmEntry",false,false,false),true,null);
