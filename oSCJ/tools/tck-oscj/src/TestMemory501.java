 ...
 * Level 1
 * 
 * - A scope may only be entered from the memory area in which it is created;
 * 
 * - Each application uses a global mission scope in the place of immortal
 * memory to hold global objects used during a mission;
 * 
 * - In initialization phase and mission phase all objects are allocated in
 * mission memory;
 * 
 * - Each schedulable object has its private scoped memory;
 * 
 * - Object creation in mission scoped memory or immortal memory during the
 * mission phase is allowed;
 * 
